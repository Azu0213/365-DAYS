...
function createMaterialCard(material) {
    ...
    card.innerHTML = `
        <div class="material-image-container">
            ...
            <img data-src="${material.images?.sample || material.image || 'catalog/placeholders/sample-tiny.jpg'}" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'%3E%3Crect width='400' height='240' fill='%23f0f0f0'/%3E%3Ctext x='200' y='120' text-anchor='middle' fill='%23999' font-family='Arial' font-size='14'%3ELoading...%3C/text%3E%3C/svg%3E" alt="${material.name}" class="material-image lazy" loading="lazy">
        </div>
...
// Removed sample request functionality as per user request
